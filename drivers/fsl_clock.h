...
#define OPAMP_CLOCKS                                                               \
    {                                                                              \
        kCLOCK_GateOPAMP0, kCLOCK_GateOPAMP2, kCLOCK_GateOPAMP2, kCLOCK_GateOPAMP3 \
    }
...
typedef enum _clock_attach_id
{
    ...
    kPll1ClkDiv_to_CLKOUT = CLK_ATTACH_MUX(kCLOCK_SelCLKOUT, 5U),      /*!< Attach Pll1ClkDiv to CLKOUT.   */
